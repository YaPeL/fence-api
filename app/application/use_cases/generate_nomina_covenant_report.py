...
NOMINA_THRESHOLD_PERCENTAGE = Decimal("5.0")
...
async def generate_and_publish_nomina_covenant_report(
    raw_assets: list[dict[str, Any]],
    publisher: CovenantReportPublisher,
) -> CovenantReport:
    assets = normalize_nomina_assets(raw_assets)
    report = calculate_nomina_covenant_report(assets)
    ...
    publication = await publisher.publish(
        PublishCovenantReportCommand(
            ...
            threshold_percentage=NOMINA_THRESHOLD_PERCENTAGE,
