...
EDUCA_THRESHOLD_PERCENTAGE = Decimal("22.0")
...
async def generate_and_publish_educa_covenant_report(
    raw_assets: list[dict[str, Any]],
    publisher: CovenantReportPublisher,
) -> CovenantReport:
    assets = normalize_educa_assets(raw_assets)
    report = calculate_educa_covenant_report(assets)
    ...
    publication = await publisher.publish(
        PublishCovenantReportCommand(
            ...
            threshold_percentage=EDUCA_THRESHOLD_PERCENTAGE,
